  ...
  static List<Request> requests() {
    ...
    return [
      Request(
        ...
        location: 'Str. Baba Novac 18, Bucharest',
        latitude: 44.4217,
        longitude: 26.1394,
      ...
      Request(
        ...
        location: 'Piata Alba Iulia, Bucharest',
        latitude: 44.4259,
        longitude: 26.1305,
      ...
      Request(
        ...
        location: 'Calea Mosilor 221, Bucharest',
        latitude: 44.4476,
        longitude: 26.1169,
      ...
      Request(
        ...
        urgency: RequestUrgency.high,
        location: 'Bd. Iuliu Maniu 59, Bucharest',
        latitude: 44.4348,
        longitude: 26.0342,
      ...
      Request(
        ...
        urgency: RequestUrgency.low,
        location: 'Str. Unirii 8, Bucharest',
        latitude: 44.4268,
        longitude: 26.1025,
      ...
      Request(
        ...
        urgency: RequestUrgency.low,
        location: 'Mega Image, Calea Mosilor, Bucharest',
        latitude: 44.4502,
        longitude: 26.1210,
      ...
      Request(
        ...
        urgency: RequestUrgency.high,
        location: 'Str. Florilor 12, Bucharest',
        latitude: 44.4310,
        longitude: 26.0985,
      ...
      Request(
        ...
        urgency: RequestUrgency.medium,
        location: 'Sos. Stefan cel Mare 12, Bucharest',
        latitude: 44.4521,
        longitude: 26.1037,
